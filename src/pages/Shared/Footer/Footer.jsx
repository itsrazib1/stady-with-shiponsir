...
const Footer = () => {
  return (
    <div>
      <footer className="footer p-10 bg-base-200 text-base-content">
        <nav>
          <header className="footer-title">CONNECT ME</header>
          <a className="link link-hover">+8801922-257757
          </a>
          <a className="link link-hover">sheponalamdu506@gmail.com</a>
          <a className="link link-hover">Outside Gate No. 4 of Govt. Saadat College, Karatia, Tangail</a>
        ...
        <form>
          <header className="footer-title">SUBCRIBE NEW LETTERS</header>
          <fieldset className="form-control w-80">
            <label className="label">
              <span className="label-text">Enter your email and we’ll send you more information.</span>
            </label>
            <div className="join">
              <input type="text" placeholder="Enter Your Email Address" className="input input-bordered join-item" />
              <button className="text-white  rounded-lg bg-gradient-to-r from-[#04e4c5] via-[#13bde4] to-[#209dff] join-item">Subscribe</button>
            </div>
          </fieldset>
        </form>
      </footer>
      <hr className="border text-slate-400" />
      <footer className="px-10 footer items-center p-4 bg-base-200 text-base-content">
  <aside className="items-center grid-flow-col">
    ...
    <p>Copyright © 2024 - All right reserved <br className="block sm:hidden" /><a className="text-blue-500 underline" href="https://itsrazib.fun/">It’s Razib</a> & <a className="text-blue-500 underline" href="https://shrabontambuli.netlify.app/">Shrabon</a></p>
