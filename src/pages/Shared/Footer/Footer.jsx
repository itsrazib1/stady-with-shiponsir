...
const Footer = () => {
  ...
  <aside className="items-center grid-flow-col">
    ...
    <p>Copyright © 2024 - All right reserved <a className="text-blue-500 underline" href="https://itsrazib.fun/">It’s Razib</a></p>&<a className="text-blue-500 underline" href="https://shrabontambuli.netlify.app/">Shrabon</a>
