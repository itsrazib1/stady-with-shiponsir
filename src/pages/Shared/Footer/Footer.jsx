    ...
    <div>
      <footer className="footer p-10 bg-base-200 text-base-content">
        <nav>
          ...
          <a className="link link-hover">(04) 3245-6988
          </a>
          <a className="link link-hover">support@constructor.com</a>
          <a className="link link-hover">A26BT5 Building, SilverC Street, London, England</a>
